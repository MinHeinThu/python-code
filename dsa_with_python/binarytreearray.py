...
binary_tree_arr = ['R', 'A', 'B', 'C', 'D', 'E', 'F', None, None, None, None, None, None, 'G']
...
def preorder_traversal(index):
    if index >= len(binary_tree_arr) or binary_tree_arr[index] is None:
        return []
    return [binary_tree_arr[index]] + preorder_traversal(left_child_index(index)) + preorder_traversal(right_child_index(index))

print(preorder_traversal(0))
